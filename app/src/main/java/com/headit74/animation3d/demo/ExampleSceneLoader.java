		...
		new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    try {
                        // this has heterogeneous faces
                        Object3DData obj54 = Object3DBuilder.loadV5(parent, Uri.parse("assets://assets/models/Rigged Hand.obj"));
                        InputStream open = ContentUtils.getInputStream(Uri.parse("assets://assets/models/"+obj54.getTextureFile()));
                        obj54.setTextureData(IOUtils.read(open));
                        obj54.centerAndScale(2.0f);
                        obj54.setPosition(new float[] { 2f, 0f, 0f });
